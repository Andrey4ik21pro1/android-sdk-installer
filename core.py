from utils import get_download_url, download_commandline_tools, add_to_path, install_platform_tools

from pathlib import Path
import os

def return_sdk_path(path):
    return path / "Android" / "Sdk"

class App:
    def __init__(self, path):
        self.android_home = return_sdk_path(Path(path))
